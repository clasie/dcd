...
//avoid current language to be a choice of language
function at_commerce_links__locale_block($variables) {
  global $language;
...
function at_commerce_preprocess_html(&$vars) {
  ...
  // Claude tooltips SF remove
  drupal_add_js($path_to_theme . '/scripts/sf_ttips.js');
